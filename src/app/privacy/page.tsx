    ...
    <main>
      ...
      <section className="pt-32 pb-16 px-4 md:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-body text-[var(--color-ink)]/60 mt-3 text-sm">
            Last updated:{" "}
          ...
          <div className="font-body text-[var(--color-ink)]/80 mt-8 space-y-6 leading-relaxed">
            <p>
            ...
            <h2 className="font-display text-xl font-semibold text-[var(--color-navy)] pt-4">
          ...
          {/* Visibility level cards */}
          <div className="grid md:grid-cols-3 gap-5 mt-8">
            {LEVELS.map((level) => (
              <div
                key={level.title}
                className="bg-white/70 border border-[var(--color-navy)]/10 rounded-2xl p-6"
              >
                <div
                ...
                <h3 className="font-display text-base font-semibold text-[var(--color-navy)] mb-3">
                  {level.title}
                </h3>
                <ul className="space-y-2">
                  {level.items.map((item) => (
                    <li
                      key={item}
                      className="font-body text-xs text-[var(--color-ink)]/70 leading-relaxed pl-3 relative before:content-['•'] before:absolute before:left-0 before:text-[var(--color-gold)]"
                    >
                      {item}
                    </li>
                  ))}
          ...
          <div className="font-body text-[var(--color-ink)]/80 mt-10 space-y-6 leading-relaxed">
            ...
            <p>
              ...
              <a
                href="/#contact"
                className="text-[var(--color-navy)] underline decoration-[var(--color-gold)]"
              >
                contact form
              </a>
              .
